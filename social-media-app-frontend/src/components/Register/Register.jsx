...
const Register = () => {
    ...
    const handleStep2 = async () => {
        ...
        try {
            await axios.put(`http://localhost:8800/api/users/${newUser._id}/coverPicture`, { coverPicture });
            setCurrentStep(3);
        } catch (error) {
    ...
    const handleStep3 = async () => {
        setLoading(true); // Set loading to true
        try {
            await axios.put(`http://localhost:8800/api/users/${newUser._id}/profilePicture`, { profilePicture });
            navigate('/login');
        } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true); // Set loading to true
        try {
            const registerData = await axios.post("http://localhost:8800/api/auth/register", registrationData);
                ...
                <div className='loginBoxRight' >
                    ...
                    {currentStep === 3 && (
                        <div>
                            ...
                            />
                            <button type="submit" onClick={handleStep3}>Register</button>
                        </div>
                    )}
