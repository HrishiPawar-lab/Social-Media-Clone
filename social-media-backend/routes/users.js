...
router.put("/:id/coverPicture", async (req, res) => {
  try {
    ...
    const coverPicture = req.body.coverPicture; // Assuming the coverPicture is sent in the request body
...
router.put("/:id/profilePicture", async (req, res) => {
  try {
    const userId = req.params.id;
    const profilePicture = req.body.profilePicture; // Assuming the coverPicture is sent in the request body
